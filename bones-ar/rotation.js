...
{
  if(!mainObj[curObj]) return;
  rotateEndPoint = projectOnTrackball(deltaX, deltaY);

  var rotateQuaternion = rotateMatrix(rotateStartPoint, rotateEndPoint);
  curQuaternion = mainObj[curObj].quaternion;
  curQuaternion.multiplyQuaternions(rotateQuaternion, curQuaternion);
  curQuaternion.normalize();
  mainObj[curObj].setRotationFromQuaternion(curQuaternion);
  mainObj[0].setRotationFromQuaternion(curQuaternion);
  mainObj[1].setRotationFromQuaternion(curQuaternion);
